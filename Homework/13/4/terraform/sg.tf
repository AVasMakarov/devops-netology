...
resource "yandex_vpc_security_group" "regional-k8s-sg" {
  ...
  ingress {
    ...
    v4_cidr_blocks    = concat(yandex_vpc_subnet.public["sub-a"].v4_cidr_blocks, yandex_vpc_subnet.public["sub-b"].v4_cidr_blocks, yandex_vpc_subnet.public["sub-d"].v4_cidr_blocks)
    from_port         = 0
    to_port           = 65535
  }
  ingress {
