...
```bash
mav@mav-pc:~/work/devops-netology/Homework/8/5/playbook/roles/clickhouse$ molecule test -s centos_7
...
```bash
mav@mav-pc:~/work/devops-netology/Homework/8/5/playbook/roles/vector-role$ molecule test
...
```bash
mav@mav-pc:~/work/devops-netology/Homework/8/5/playbook/roles/vector-role$ docker run --privileged=True -v ~/work/devops-netology/Homework/8/5/playbook/roles/vector-role:/opt/vector-role -w /opt/vector-role -it aragast/netology:latest /bin/bash
